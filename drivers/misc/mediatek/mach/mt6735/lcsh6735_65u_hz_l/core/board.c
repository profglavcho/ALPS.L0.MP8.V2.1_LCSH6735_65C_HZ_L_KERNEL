...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_ett_settings msdc0_ett_settings[] = {
        ...
        { MSDC_HS400_MODE, 0x188, (0x1f<<12), 0xF /*0x13*/}, //EMMC50_PAD_DS_TUNE[MSDC_EMMC50_PAD_DS_TUNE_DLY3]
        ...
        { MSDC_HS200_MODE, 0xf0,  (0x1f<<16), 0xb }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRDLY]
        { MSDC_HS200_MODE, 0xf0,  (0x1f<<22), 0x8 }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRRDLY]
        ...
        { MSDC_HS400_MODE, 0xf0,  (0x1f<<16), 0x7 }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRDLY]
        { MSDC_HS400_MODE, 0xf0,  (0x1f<<22), 0x4 /*0x0*/ }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRRDLY]

        /* write ett settings */
        { MSDC_HS200_MODE, 0xb4,  (0x7 << 0), 0xA }, //PATCH_BIT1[MSDC_PB1_WRDAT_CRCS_TA_CNTR]
        { MSDC_HS200_MODE, 0xf0,  (0x1f<< 0), 0x1 }, //PAD_TUNE[MSDC_PAD_TUNE_DATWRDLY]
        { MSDC_HS200_MODE, 0x4,   (0x1 <<10), 0x9 }, //MSDC_IOCON[MSDC_IOCON_W_D0SPL]
