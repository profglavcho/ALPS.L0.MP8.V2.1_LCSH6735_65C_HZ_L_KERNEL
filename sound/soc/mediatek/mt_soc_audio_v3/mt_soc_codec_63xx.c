...
//        upmu_set_rg_vio18_cal(1);// for MT6328 E1 VIO18 patch only
        ...
        Ana_Set_Reg(AUDDEC_ANA_CON6, 0x0841, 0xffff); //Enable cap-less HC LDO (1.5V) & LDO VA33REFGEN
...
//        Ana_Set_Reg(AUDDEC_ANA_CON0, 0xE000, 0xffff); //Disable headphone, voice and short-ckt protection. HP and voice MUX is opened
        ...
        Ana_Set_Reg(AUDDEC_ANA_CON6, 0x28C0, 0xffff); //
        ...
        //udelay(50);
        Ana_Set_Reg(AUDDEC_ANA_CON6, 0x2AC2, 0xffff); //Enable AUD_CLK
